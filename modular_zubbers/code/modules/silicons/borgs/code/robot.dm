...
/mob/living/silicon/robot
	...
	held_state = "cat"
	var/list/obj/item/robot_components/components = list()
	///Same as [above][/mob/living/silicon/robot/var/components], but stores "slot ID" - "component" pairs for easy access.
