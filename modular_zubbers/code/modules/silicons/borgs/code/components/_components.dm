...
Components work in several ways:
	...
	2 - Armor
	3 - Additional features and functions on a cyborg
*/
...
/obj/item/robot_component
	...
	//Compoent variables for determining what we alert the owner with when they pass/clear the damage thresholds
	var/prev_damage = 0
...
/obj/item/robot_component/proc/check_damage_thresholds(mob/component_owner)
