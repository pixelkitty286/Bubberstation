...
//A define waterpig put here idk
...
/datum/species/tajaran/create_pref_unique_perks()
	...
	to_add += list(
		...
		list(
			...
			SPECIES_PERK_DESC = "Tajara have eyes that are adapted to low light, and can see in the dark better than most species.",
		),
		list(
			SPECIES_PERK_TYPE = SPECIES_NEGATIVE_PERK,
